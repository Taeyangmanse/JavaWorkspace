...
public class Run 
{
	public static void main(String[] args) 
	{
		 ...
		 * - 컬렉션에 데이터를 추가할 때 항상 Object 객체로 저장해야 했다.
		 * - 저장된 데이터를 꺼내서 활용 시에는 항상 "강제 형변환"이 필요하다.
		 * - 단, 형변환 시 잘못된 자료형으로의 형변환을 진행한다면 에러가 발생할 수 있다.
		 * 
		 * 
		 */
		 ...
		 * - 클래스의 메서드의 "반환형", "매개변수", 필드의 "자료형"들을 미리 확정짓지 않고 파라미터화 하여 나중에 지정할 수 있게 만드는 문법
		 * - 즉, 제네릭을 사용하면 다양한 자료형(타입)들을 저장할 수 있기 때문에 타입 변수 라고도 불린다.
