...
public class WebCralwer {
	...
	/*
	 * URL을 활용한 웹 크롤링 - 웹 페이지를 탐색하여 HTML 내부의 원하는 데이터를 추출하는 작업 - 수집한 뎅터를 분석하기 위하여
	 * 사용한다. - 다만 웹 체이지의 소유주나 운영자의 허락없이 크롤링 시 법적 책임이 따를 수 이싿.
	 * 
	 */

	public void test1() {
		String address = "https://khedu.co.kr/project/team.kh";
		List<String> imgList = new ArrayList<>(); // img파일이 존재하는 결로를 저장할 컬렉션
	...
	private void saveFile(List<String> imgList) {
		// imgList의 길이만큼 반복하여, URL 객체를 생성하고 이미지를 다운로드
